...
public class Rook extends ChessGamePiece {
	...
	public ImageIcon createImageByPieceType() {
		...
		iconsMap.put(-1, "../../assets/default-Unassigned.gif");
		iconsMap.put(ChessGamePiece.BLACK, "../../assets/BlackRook.gif");
		iconsMap.put(ChessGamePiece.WHITE, "../../assets/WhiteRook.gif");
